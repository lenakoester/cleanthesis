...
% **************************************************
\newcommand{\thesisTitle}{Usability Evaluation eines Rückmeldesystems der Berliner Wasserbetriebe}
\newcommand{\thesisName}{Lena Köster}
\newcommand{\thesisSubject}{Documentation}
\newcommand{\thesisDate}{October 4, 2015}
\newcommand{\thesisVersion}{My First Draft}

\newcommand{\thesisFirstReviewer}{Prof. Dr. Juliane Siegeris}
